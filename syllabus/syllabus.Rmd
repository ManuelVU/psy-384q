...
<p class="description-section">
  There are two type of assignments for this class, the first one is take home
  case studies, and the second one is a final project. Take home case studies
  will be in the form of an RMarkdown file that describes a problem. The 
  objective will be for you to find a way to answer the posed problem using the
  methods seen in class, and write the results in a format that resembles the
...
<p class="description-section">
  ...
  of in-class case studies), homeworks (no more than 6 applications to case 
  studies), and final project, with a weight of 20, 45, and 35% respectively. 
  For the determination of letter grades at the end of the class, I will use my 
  predecessor’s graduate class grading scale: A=80+, B=60-79.99, C=59.99-and-below. 
